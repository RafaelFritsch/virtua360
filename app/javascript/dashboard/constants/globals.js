export default {
  ...
  DOCS_URL: '//www.virtuacrm.com/docs/product/',
  HELP_CENTER_DOCS_URL: '//www.virtuacrm.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.virtuacrm.com/content.json',
